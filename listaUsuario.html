						...
						<table class="table table-hover">
							...
							<tbody>
								<tr>
									...
									<td style="text-align: center;">ALLAN.MIRANDA</td>
									<td style="text-align: center;"><a href=""><i class="glyphicon glyphicon-info-sign"></i></td>
									<td style="text-align: center;"><a href=""><i class="glyphicon glyphicon-remove-circle"></i></a></td>
								</tr>
							</tbody>
						</table>
					</div>
