            ...
            <div class="col-sm-12 paragrafo">
                <p>
                    ...
                    conformidade com a legalidade vigente na Portaria nº 119/2012 - GS/SESED informa que o cadáver registrado no Instituto de Medicina Legal - IML sob <b>NIC
                        <?php echo $row["necropapiloscopia_nic_numero"]; ?></b>, procedente do <?php echo $row["necropapiloscopia_procedente_bairro"] . " " . $row["necropapiloscopia_procedente_cidade"] . " " . $row["necropapiloscopia_procedente_uf"]; ?>, <b><u>não apresentava condições à coleta de Impressões
                            Digitais</u></b> com a qualidade mínima necessária ao confronto necropapiloscópico <?php echo $row["necropapiloscopia_coleta_motivo"]; ?>.
                </p>
            </div>
        </div>
        <br><br>
