                ...
                <div class="col-md-12 widget-shadow">
                    <div class="panel-default">
                        <div class="panel-body">
                            ...
                            <form action="" method="" class="com-mail">
                                <select class="form-control1 control3">
                                    <option>SETOR UM</option>
                                    <option>SETOR UM</option>
                                    <option>SETOR UM</option>
                                </select>
                                <input type="text" class="form-control1 control3" placeholder="Assunto:">
                                <textarea rows="6" class="form-control1 control2" placeholder="Mensagem:"></textarea>
