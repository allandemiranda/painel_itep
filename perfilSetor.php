...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_perfil_setor_modificar = "UPDATE `setores_tb` SET `setor_nome`='" . $setor_nome . "',`setor_sala`='" . $setor_sala . "',`setor_hall`='" . $setor_hall . "',`setor_admin`='" . $setor_admin . "' WHERE `setor_id`='" . $setor_id . "'";
                    ...
                    <div class="form-grids row widget-shadow" data-example-id="basic-forms">
                        ...
                        <div class="form-body">
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                                ...
                                $sql_perfil_setor_selecionar = "SELECT `setor_id`, `setor_nome`, `setor_sala`, `setor_hall`, `setor_admin` FROM `setores_tb` WHERE `setor_id`='" . $setor_id . "'";
