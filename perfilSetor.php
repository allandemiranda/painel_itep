            ...
            <aside class="sidebar-left">
                <nav class="navbar navbar-inverse">
                    <div class="navbar-header">
                        ...
                        <h1 class="navbar-brand" href="index.html" style="margin-top: 5%;"> ITEP RN</h1>
                    </div>
                        ...
                        <div class="form-body">
                            <form action="" method="">
                                <div class="form-group">
                                    ...
                                    <input name="setor_nome" type="text" class="form-control"
                                        placeholder="Nome do Setor"
                                        onChange="javascript:this.value=this.value.toUpperCase();" value="" required>
                                </div>
                                <div class="form-group">
                                    <label>Sala</label>
                                    <input name="setor_sala" type="text" class="form-control" value=""
                                        placeholder="Sala do Setor"
                                        onChange="javascript:this.value=this.value.toUpperCase();" required>
                                </div>
                                <div class="checkbox">
                                    <label>
                                        <input name="setor_atendimento" type="checkbox" class="checkbox"
                                            placeholder="Sala do Setor"
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input name="setor_admin" type="checkbox" class="checkbox"
                                            placeholder="Sala do Setor"
                                            onChange="javascript:this.value=this.value.toUpperCase();">
