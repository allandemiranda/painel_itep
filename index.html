			...
			<div class="main-page">
				...
				<div class="tool-tips widget-shadow">
					...
					<ul id="myTabs" class="nav nav-tabs" role="tablist">
						<li role="presentation" class="active"><a href="#naoAtendidos" id="naoAtendidos-tab" role="tab"
								data-toggle="tab" aria-controls="naoAtendidos" aria-expanded="true"><button
									type="button" class="btn btn-danger">Não
									atendido</button></a>
						</li>
						<li role="presentation" class=""><a href="#emAtendimento" id="emAtendimento-tab" role="tab"
								data-toggle="tab" aria-controls="emAtendimento" aria-expanded="false"><button
									type="button" class="btn btn-success">Em
									antendimento</button></a>
						</li>
						<li role="presentation" class=""><a href="#atendidos" id="atendidos-tab" role="tab"
								data-toggle="tab" aria-controls="atendidos" aria-expanded="fase"><button type="button"
									class="btn btn-info">Atendido</button></a>
						</li>
					</ul>
					<div id="myTabContent" class="tab-content scrollbar1">
						<div role="tabpanel" class="tab-pane fade active in" id="naoAtendidos"
							aria-labelledby="naoAtendidos-tab">
							<div class="tables">
										...
										<tbody>
											<tr>
												...
												<td style="text-align: center;"><button type="button"
														...
														data-placement="top" title="SECRETARIA"
														data-original-title="">Encaminhado</button></td>
												<td style="text-align: center;">00/00/0000 00:00</td>
												<td style="text-align: center;"><span
														class="label label-warning">SIM</span></td>
											</tr>
											<tr>
												<th scope="row" style="text-align: center;">1</th>
												<td style="text-align: center;">ALLAN DE MIRANDA</td>
												...
												<td style="text-align: center;">00/00/0000 00:00</td>
												<td style="text-align: center;"><span
														class="label label-success">NÃO</span></td>
											</tr>
										</tbody>
									</table>
								</div>
						...
						<div role="tabpanel" class="tab-pane fade" id="emAtendimento"
							aria-labelledby="emAtendimento-tab">
							<div class="tables">
								<div class="bs-example" data-example-id="hoverable-table">
									<table class="table table-hover">
										<thead>
										...
										<tbody>
											<tr>
												...
												<td style="text-align: center;"><button type="button"
														...
														data-target="#emAtendimento1Modal">Em
														antendimento</button></td>
												<td style="text-align: center;">00/00/0000 00:00</td>
												<td style="text-align: center;"><span
														class="label label-success">NÃO</span></td>
											...
											<tr>
												...
												<td style="text-align: center;"><button type="button"
														class="btn btn-success" data-toggle="modal"
														data-target="#emAtendimento2Modal">Em
														antendimento</button></td>
												<td style="text-align: center;">00/00/0000 00:00</td>
												<td style="text-align: center;"><span
														class="label label-warning">SIM</span></td>
										...
										<!-- Modal -->
										<div class="modal fade" id="emAtendimento1Modal" tabindex="-1" role="dialog"
														...
														<div class="form-grids row widget-shadow"
															...
															<div class="form-body">
																<form action="" method="">
																	<div class="form-group">
																		<label>Nome </label>
																		<input name="setor_nome" type="text"
																			class="form-control"
																			placeholder="Nome Completo"
																			onChange="javascript:this.value=this.value.toUpperCase();"
																	...
																	<div class="form-group">
																		<label>Telefone</label>
																		<input name="setor_sala" type="tel"
																			class="form-control" value=""
																			placeholder="(84) 00000-0000" required
																			disabled>
																	</div>
																	<div class="form-group">
																		<label>Encaminhar para</label>
																		<select name="usuario_setor"
																	...
																	<button type="submit"
																		class="btn btn-warning">Encaminhar</button>
																	<a href=""><button type="button"
																			class="btn btn-success">Finalizar</button></a>
																	<button type="button" class="btn btn-danger"
																		data-dismiss="modal">Cancelar</button>
																</form>
															</div>
										...
										<tbody>
											<tr>
												...
												<td style="text-align: center;"><a href=""><button type="button"
															class="btn btn-info">Atendido</button></a></td>
												<td style="text-align: center;">00/00/0000 00:00</td>
												<td style="text-align: center;"><span
														class="label label-warning">SIM</span></td>
											</tr>
